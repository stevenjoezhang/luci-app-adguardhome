...
doupx(){
    ...
    *)
        echo "error not support $um if you can use official release please issue a bug"
        exit 1
        ;;
	esac
...
doupdate_core(){
    ...
    case "$um" in
        ...
        # ------------ Others ----------
        *)
            echo "error not support $um, if you can use official release please file a bug"
            exit 1
            ;;
    esac
	fi
